...
export function isExtendedStringOrDefault<T extends string>(value: unknown, defaultValue: T): T {
...
export function isBooleanOrDefault(value: unknown, defaultValue = false): boolean {
