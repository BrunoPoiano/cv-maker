...
export function generateDate(job: Curriculum['Experience']['value'][number], language: Languages, dateFormat: MonthOptions) {
...
export function fixDate(date: unknown, language: Languages, dateFormat: MonthOptions) {
