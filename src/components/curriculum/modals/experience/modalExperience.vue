...
<template>
	<Modal buttonLabel="Experience" closeLabel="close" minWidth="40rem" v-if="curriculum" buttonIcon="/svgs/pen.svg">
		<template #header>
		...
		<form>
			<div class="size">
				<AppInput divStyle="align-self: center" type="checkbox" label="Side by Side" v-model="curriculum.Experience.sideBySide" />
				<Select label="Title" :items="fontSizeSelect" v-model="curriculum.Experience.size.title" />
				<Select v-if="!curriculum.Experience.sideBySide" label="Subtitle" :items="fontSizeSelect" v-model="curriculum.Experience.size.subTitle" />
